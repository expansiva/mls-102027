 ...
 */
import { Directive, PartInfo, DirectiveClass, DirectiveResult } from '/_100000_directive.js';
import { AttributePart, Part, Disconnectable } from '/_100000_/litHtml.js';
import type { PropertyPart, ChildPart, BooleanAttributePart, EventPart, ElementPart, TemplateInstance } from '/_100000_/litHtml.js';
/**
...
export declare const _$LH: {
    ...
    resolveDirective: (part: ChildPart | AttributePart | ElementPart, value: unknown, parent?: import("/_100000_/litHtml.js").DirectiveParent, attributeIndex?: number) => unknown;
